  ...
  return (
    <>
      ...
      <section>
        ...
        <h1 className="header_home">
          {" "}
          Travel is not just about discovering new places; it&apos;s about
          uncovering new perspectives, enriching our souls with experiences, and
          collecting moments that become cherished memories for a lifetime.
        </h1>
